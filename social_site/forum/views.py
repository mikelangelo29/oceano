...
def crea_discussione (request, pk):
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                  ...
                  discussione.save()
                  primo_post = Post.objects.create(discussione=discussione, 
...
def visualizza_discussione(request, pk):
     ...
     posts_discussione = Post.objects.filter(discussione=discussione).order_by("-data_creazione")
     paginator=Paginator(posts_discussione, 7)
